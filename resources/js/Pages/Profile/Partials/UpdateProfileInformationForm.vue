...
<template>
<div class="bg-white bg-opacity-90 px-4 py-4 rounded-lg overflow-hidden shadow-lg">
    <div class="grid grid-cols-12 border-b pb-4">
        <div class="col-span-3 flex items-center">
            <div>
                <img class="rounded-full mx-auto" src="/images/item-1.jpg" width="100"/>
                <svg class="flex items-center mx-auto w-5 h-5 text-gray-600 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="col-span-9">
            <div class="relative z-0 pl-4 sm:pl-1">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                    <svg class="w-5 h-5 text-gray-600 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path d="M5.433 13.917l1.262-3.155A4 4 0 017.58 9.42l6.92-6.918a2.121 2.121 0 013 3l-6.92 6.918c-.383.383-.84.685-1.343.886l-3.154 1.262a.5.5 0 01-.65-.65z"></path>
                        <path d="M3.5 5.75c0-.69.56-1.25 1.25-1.25H10A.75.75 0 0010 3H4.75A2.75 2.75 0 002 5.75v9.5A2.75 2.75 0 004.75 18h9.5A2.75 2.75 0 0017 15.25V10a.75.75 0 00-1.5 0v5.25c0 .69-.56 1.25-1.25 1.25h-9.5c-.69 0-1.25-.56-1.25-1.25v-9.5z"></path>
                    </svg>
                </div>
        ...
        <div class="col-start-8 col-span-3 flex items-center gap-4">
            <Transition enter-from-class="opacity-0" leave-to-class="opacity-0" class="transition ease-in-out">
                <p v-show="form.recentlySuccessful" class="text-sm text-gray-600">登録しました</p>
            </Transition>
        </div>
    </div>
    <div class="flex justify-end">
        <button @click="logout" class="text-red-500 font-medium inline-flex mt-4 pr-2">
            <svg class="inline-flex w-5 pb-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
